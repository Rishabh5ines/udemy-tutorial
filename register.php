...
<section class="login-register">
    <div class="row">
        <div class="col m12 s12 l12">
                    ...
                    <div class="user_options-text">
                        ...
                        <div class="user_options-unregistered">
                            ...
                            <p class="user_unregistered-text">Banjo tote bag bicycle rights, High Life sartorial cray craft beer whatever street art fap.</p>
                             <p class="user_unregistered-text">If You allready register .  please logi.</p>
                            <!-- <button class="user_unregistered-signup" id="signup-button">Sign up</button> -->
                            <a href="login.php" class="waves-effect waves-light btn btn-form">LOG IN</a>
                             <div class="font-away">
                                    <span class="font-aws1"><i class="fa fa-facebook-square" aria-hidden="true"></i></span>
                                    <span class="font-aws1"><i class="fa fa-twitter-square" aria-hidden="true"></i></span>
                                    <span class="font-aws1"><i class="fa fa-linkedin-square" aria-hidden="true"></i></span>
                                    <span class="font-aws1"><i class="fa fa-instagram" aria-hidden="true"></i></span>
                                </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col m6 s12 l6">
                        <div class="user-account-register" id="user-account-register">
                            <center><img src="assets/image/login/register.png" class="responsive-img login-page"></center>
                            <h2 class="forms_title1 text-center">SIGN UP AND START LEARNING</h2>
                            <form class="forms_form">
                                <div class="row">
                                    <div class="pdd50">
                                        <div class="input-field col s12 m12">
                                            <input id="last_name" type="text" class="validate" required="">
                                             <label for="last_name">Enter your Fullname</label>
                                         </div>
                                         <div class="input-field col s12 m12">
                                            <input id="last_name" type="email" class="validate1" required="">
                                            <label for="last_name">Enter you Email</label>
                                         </div>
                                         <div class="input-field col s12 m12">
                                            <input id="last_name" type="text" class="validate1" required="" minlength="10">
                                            <label for="last_name">Enter you Password</label>
                                         </div>
                                         </div>   
                                        ...
                                        <div class="col s12 m12 padd-btn1 "> 
                                           <!--  <input type="submit" value="Submit" class="waves-effect waves-light btn-small text-right"> -->
                                            <button><a class="waves-effect waves-light btn full-width-btn" type="submit" value="Submit" reruired="" >Submit</a></button>
                                        </div>
                                    </div>
                                </form>
                                <div class="or-value">
